                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="localite"  value="{{ $personne->localite }}" class="form-control"  required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Nature du bien impacté</label>
                                            <input type="text" name="nature"  value="{{ $personne->nature }}" class="form-control"  required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Cause du sinistre</label>
                                            <input type="text" name="cause"  value="{{ $personne->cause }}" class="form-control"  required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                   ...
                                   <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Besoin</label>
                                            <textarea class="form-control" name="besoin" required> {{ $personne->besoin }} </textarea>
                                        </div>
                                    </div>
